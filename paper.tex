...
(\ref{intuitionistic-interval}) is satisfied. To clarify, the $height$
...
% How a classic fuzzy set is represented as a ifs. How an intuitionistic
% fuzzy set is represented in this work.

% How the non-membership is going to affect the membership (show
% formula). Present both examples (stating the parameters).
