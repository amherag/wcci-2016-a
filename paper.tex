...
case is shown in Figure \ref{ifs-diff-mu-sd}. To clarify, the $height$
...
0.6$, is depicted in Figure \ref{alpha-cut-example}.
...
Table \ref{hypothesis-tests-training} summarizes the results obtained
...
followed in Table \ref{hypothesis-tests-testing}, which shows the
...
\begin{table}[!t]
  ...
  \label{hypothesis-tests-testing}
  \centering
  \begin{tabular}{|c|c|c|c|c|c|}
    \hline
...
developed by J. R. Castro $et al.$ \cite{castro2007interval}. The
