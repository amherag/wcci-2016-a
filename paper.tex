...
C. Cornelis and G. Deschrijver \cite{cornelis2001compositional}
generalize the Compositional Rule of Inference to IFSs
%intuitionistic inference engine \cite{cornelis2001compositional} %Que
                                %diferencias hay?

A method for inference in approximate reasoning based on normal
intuitionistic fuzzy sets \cite{bustince1995method}


A Method and Electronic Circuit for Intuitionistic Fuzzy Inference
\cite{marinov2005method}
An intuitionistic fuzzy system for time series analysis in plant
monitoring and diagnosis \cite{castillo2007intuitionistic}

% Applications
Intuitionistic fuzzy sets in some medical applications
\cite{szmidt2001intuitionistic}
Switching between type-2 fuzzy sets and intuitionistic fuzzy sets: an
application in medical diagnosis \cite{own2009switching}
Intuitionistic preference relations and their application in group
decision making \cite{xu2007intuitionistic}
An application of intuitionistic fuzzy information for handwritten
Arabic word recognition \cite{baccour2008application}
